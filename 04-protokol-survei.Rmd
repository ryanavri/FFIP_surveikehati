...
```{r mistnet, echo=FALSE, out.width = '100%',fig.align='center',fig.cap='Ilustrasi pemasangan jaring kabut; (a) Pintu hutan (b) diatas sungai dan, (c) detil pemasangan jaring kabut yang longgar di setiap segmen (sumber; (Borisenko and Kruskop, 2003))'}
...
```{r kelmor, echo=FALSE, out.width = '100%',fig.align='center',fig.cap='Ilustrasi pengukuran bagian tubuh kelelawar (sumber; Borisenko and Kruskop, 2003)'}
