...
**Persiapan untuk dapat memberikan pertolongan pertama.** Ada baiknya seluruh anggota tim, dilatih untuk dapat memberikan pertolongan pertama dengan benar dari pelaku medis profesional setempat (Dokter, petugas puskesmas, KSR PMI dll). Sehingga mereka sudah siap memberikan pertolongan kepada siapapun yang membutuhkan. Peralatan pertolongan pertama yang akan dibawa setidaknya mencakup; seperangkat peralatan penutup luka, tablet antibiotik, tablet malaria, bubuk rehidrasi, salep atau bedak anti jamur dan anti gatal, salep luka bakar dan _snake bite-kit_. 
...
**TERPENTING. _Use common sense!_.** Seringkali kecelekaan terjadi karena hal yang dari awal dapat dihindari seperti menyebrang sungai deras tanpa pengaman, memanjat pohon untuk mencari sinyal, tersesat karena panik, memanjat tebing terjal tanpa bantuan tali dan lain-lain. Selalu ketahui batas diri masing-masing, anggota tim yang lain mungkin dapat melompat diantara celah tebing dengan mudah, atau melewati tebing hanya dengan menyebrangi sebatang kayu yang dijadikan jembatan, namun anda belum tentu dapat melewatinya. Merupakan pilihan yang bijak untuk berpikir mengenai keselamatan diri dan membuat alternatif pilihan terhadap hambatan yang ditemui.

## Pembuatan Transek {-}

<!--chapter:end:02-pra-survei.Rmd-->
...
<!--chapter:end:03-rancangan-survei.Rmd-->
...
Dalam konteks kajian yang biasa dilakukan oleh FFI`s IP biasanya menggunakan metode pengamatan langsung menggunakan transek garis yang dikombinasikan dengan metode eksplorasi, sedangkan untuk metode penangkapan, dapat menggunakan _live trap_, jaring kabut, perangkap harpa hingga kamera pengintai (_camera trap_). Metode menggunakan kamera pengintai akan dijabarkan dalam panduan khusus, namun hasil yang didapat dari kamera pengintai dapat dikombinasikan dengan kajian ini untuk melengkapi daftar spesies, terutama jenis-jenis yang elusif

Target taksa dari setiap metode terangkum dalam ~~Tabel 1~~. Dalam praktiknya, kajian keanekaragaman hayati mamalia, tidak perlu menggunakan semua perangkat yang disebutkan. Sesuaikan perangkat yang akan dibawa dengan tujuan survei serta sumber daya yang tersedia.
...
Table: (\#tab:tbtm) Peran dan tanggung jawab tim mamalia
...
1.	Pengamatan di transek garis dilakukan pada pagi hari pukul 06:00 dan berjaringn secara perlahan hingga ke ujung transek sejauh 2000 m, kemudian melakukan pengamatan  lagi pada malam hari. Pengamatan malam dapat dimulai pada pukul 16:00 jika bertujuan untuk sambil memasang perangkap, atau jam 19:00 jika hanya melakukan transek garis.
2.	Berjaringn secara perlahan dan konsisten, serta usahakan sesunyi mungkin sambil memperhatikan keberadaan satwa liar.
3.	Pengamat utama harus membagi tim untuk personil yang khusus mencari satwa secara langsung di tajuk-tajuk pohon untuk mendeteksi primata dan satwa arboreal lainnya. Personil ini harus selalu berjaringn sepanjang jalur utama transek dan berada di barisan paling depan.
...
5.	Apabila melihat satwa secara langsung, usahakan catat jarak perpendikular satwa tersebut dari jalur transek (Gambar \@ref(fig:figppd)), kemudian catat temuan tersebut di lembar data mamalia (Gambar \@ref(fig:ldmtg)). Apabila kondisi memungkinkan, berhenti sejenak untuk dapat mengambil foto satwa tersebut.
6.	Apabila menemukan jejak satwa berupa tapak, kotoran, cakaran dan jejak visual lainnya catat di lembar data dan foto temuan tersebut menggunakan ukuran pembanding (Gambar \@ref(fig:pugm)).
...
```{r figppd, echo=FALSE, out.width = '100%',fig.align='center',fig.cap='Ilustrasi jarak perpendikular terhadap transek'}
knitr::include_graphics("images/ppd_ilustration.jpg")
```

```{r pugm, echo=FALSE, out.width = '100%',fig.align='center',fig.cap='Ilustrasi pengambilan gambar jejak dengan ukuran pembanding (sumber: doi:10.1371/journal.pone.0172065.g003 )'}
knitr::include_graphics("images/pugmark.png")
```
...
```{r lvtrap, echo=FALSE, out.width = '100%',fig.align='center',fig.cap='(a) perangkap kasmin (b) perangkap sherman (sumber; shermantraps.com)'}
knitr::include_graphics("images/livetrap.jpg")
```

```{r stot, echo=FALSE, out.width = '100%',fig.align='center',fig.cap='Perangkap sherman yang dipasang diatas pohon (sumber; Díaz-N. et al., 2011)'}
knitr::include_graphics("images/stontrees.png")
```
...
6.	Catat lokasi perangkap dan umpan yang digunakan ke dalam lembar data perangkap (Gambar \@ref(fig:ldmpk))
...
8.	Bila ada satwa yang tertangkap, keluarkan menggunakan sarung tangan yang tebal, lalu masukan ke dalam kantong kain untuk melakukan pengukuran bagian tubuh di kamp. Bagian tubuh yang biasa diukur adalah panjang tubuh (HB), panjang kaki belakang (HF) dan panjang ekor (T) (Gambar \@ref(fig:mfsm)). Jika sudah selesai diidentifikasi dan difoto, maka lepaskan kembali hewan di tempat tertangkap.

```{r mfsm, echo=FALSE, out.width = '100%',fig.align='center',fig.cap='Ilustrasi pengukuran bagian tubuh untuk mamalia kecil'}
knitr::include_graphics("images/mfm_ilustration.jpg")
```
...
```{r mistnet, echo=FALSE, out.width = '100%',fig.align='center',fig.cap='Ilustrasi pemasangan jaring kabut'}
knitr::include_graphics("images/mistnetuses.png")
```
...
```{r kelmor, echo=FALSE, out.width = '100%',fig.align='center',fig.cap='Ilustrasi pengukuran bagian tubuh kelelawar (sumber: Borisenko & Kruskop, 2003)'}
knitr::include_graphics("images/kfm_ilustration.jpg")
```
...
Table: (\#tab:tabpv) Peralatan yang dibutuhkan tim vegetasi

| Peralatan | Penggunaan  | Spesifikasi |
|:----|:------|:----|
| Diameter tape 3M (x 2) dan 1 M (x1) | Pengukuran diameter pohon | Bahan _fiber_ dan angka tidak mudah pudar |
| Meteran pengukur 100 M (x1) dan 30 M (x1) | Pengukuran batas-batas petak | Bahan _fiber glass_, angka tidak mudah pudar |
| Tali rapia/ flagging tape | Penanda garis-garis atau titik batas. Khusus rapia, setelah penggunaan harus dilepas kembali. | Berwarna mencolok, awet dan _biodegradable_ |
...
| Kamera digital (_prosummer_/SLR) | Foto spesimen, rona lingkungan, karakter tumbuhan | Perbesaran lensa min. 25x, memiliki fungsi _macro_ dan _stabilizer_ |
...
Table: (\#tab:tabpvil) Petak dan anak-petak persegi untuk tiap kategori vegetasi.

| Ukuran sub-petak | DBH | Kategori | Kelas |
|:---|:---|:---|:---|
| 10 m x 10 m | 5 - 15 cm | Tiang & pancang | C |
| 20 m x 20 m | 15 - 30 cm | Pohon kecil | B |
| 20 m x 125 m | > 30 cm | Pohon Besar | A |

```{r figpv, echo=FALSE, out.width = '100%',fig.align='center',fig.cap='Bentuk dan peletakan petak persegi terhadap jalur transek'}
knitr::include_graphics("images/pv_ilustration.jpg")
```

Alur kerja survei di lapangan untuk vegetasi dan biomassa pohon adalah sebagai berikut:

```{r figav, echo=FALSE, out.width = '100%',fig.align='center',fig.cap='Diagram alur kerja survei vegetasi'}
knitr::include_graphics("images/av_ilustration.jpg")
```
...
* **Kontur tanah cenderung rata.** Bila kontur permukaan tanah dimana petak akan dibuat cenderung rata, maka pembuatan petak dapat dilakukan dengan pembuatan batas-batas petak secara langsung sesuai Gambar \@ref(fig:figpv) di atas.
...
```{r figtiv, echo=FALSE, out.width = '100%',fig.align='center',fig.cap='Bentuk dan ukuran petak dan sub-petak dengan teknik tulang ikan'}
knitr::include_graphics("images/tiv_ilustration.jpg")
```
...
```{r figrlv, echo=FALSE, out.width = '100%',fig.align='center',fig.cap='Contoh gambar foto rona lingkungan'}
knitr::include_graphics("images/rlv_ilustration.jpg")
```

#### Pengukuran tutupan tajuk{-}
Tutupan kanopi sangat erat kaitannya dengan dinamika ekosistem di bawahnya seperti menyediakan iklim mikro bagi vegetasi dan habitat beragam satwa. Untuk mengukur tutupan tajuk, ukur persentase tutupan kanopi menggunakan densiometer atau kamera lensa _fisheye_. Lakukan pengukuran di titik (10,0); (10,50); dan (10,100). Pendugaan tutupan tajuk seperti pada Gambar \@ref(fig:figpkv)

```{r figpkv, echo=FALSE, out.width = '100%',fig.align='center',fig.cap='Contoh pendugaan tutupan tajuk. (Sumber; https://doi.org/10.1016/j.uclim.2019.01.004)'}
knitr::include_graphics("images/pkv_ilustration.jpg")
```
...
Table: (\#tab:bkk) Teknik-teknik pengukuran diameter batang dengan kondisi khusus
...
| **Pohon cacat (_deform_) di titik 1,3 m.** Jika di titik 1,3m dari permukaan tanah, batang tidak bulat sempurna/cacat. maka titik pengukuran adalah pada 0,3m di atas dari ujung bagian yang cacat tersebut | ![](images/vtb2.jpg) |
| **Pohon miring (_leaning_).** Pengukuran pada pohon miring dilakukan dengan mengukur 1,3m dari tanah pada sisi arah miring pohon tersebut/sisi yang terdekat dengan tanah | ![](images/vtb3.jpg) |
...
```{r figdst, echo=FALSE, out.width = '100%',fig.align='center',fig.cap='Alat distometer dan konsep pengukuran tinggi pohon. (Sumber:theoriginallaserdistancemeter.co.uk)'}
knitr::include_graphics("images/dst_ilustration.jpg")
```
...
Table: (\#tab:tabgkj) Contoh-contoh pengambilan gambar karakter jenis
...
```{r figtag, echo=FALSE, out.width = '100%',fig.align='center',fig.cap='Contoh pemasangan plat tagging'}
knitr::include_graphics("images/tagging.jpg")
```


<!--chapter:end:04-protokol-survei.Rmd-->

# Analisa Data {-}


<!--chapter:end:05-analisa-data.Rmd-->

# Pengelolaan Data {-}


<!--chapter:end:06-pengelolaan-data.Rmd-->

`r if (knitr::is_html_output()) '
# Referensi {-}
'`

<!--chapter:end:07-referensi.Rmd-->
...
```{r ldpth, echo=FALSE, out.width = '100%',fig.align='center',fig.cap='Contoh lembar data untuk metode titik hitung'}
...
```{r ldppl, echo=FALSE, out.width = '100%',fig.align='center',fig.cap='Contoh lembar data untuk parameter lingkungan di setiap titik hitung'}
...
```{r ldpml, echo=FALSE, out.width = '100%',fig.align='center',fig.cap='Contoh lembar data untuk daftar jenis MacKinnon'}
knitr::include_graphics("images/ldp_ml.jpg")
```

## Lembar Data Herpetofauna {-}

**Lembar data pengamatan menggunakan metode _VES_**
...
```{r ldhves, echo=FALSE, out.width = '100%',fig.align='center',fig.cap='Contoh lembar data untuk metode VES'}
knitr::include_graphics("images/ldh_ves.jpg")
```
...
```{r ldmtg, echo=FALSE, out.width = '100%',fig.align='center',fig.cap='Contoh lembar data untuk metode transek garis'}
knitr::include_graphics("images/ldm_tg.jpg")
```
...
```{r ldmpk, echo=FALSE, out.width = '100%',fig.align='center',fig.cap='Contoh lembar data untuk pengamatan menggunakan perangkap'}
knitr::include_graphics("images/ldm_pk.jpg")
```
...
```{r ldmp, echo=FALSE, out.width = '100%',fig.align='center',fig.cap='Contoh lembar data informasi perangkap'}
knitr::include_graphics("images/ldm_p.jpg")
```
...
```{r ldvip, echo=FALSE, out.width = '100%',fig.align='center',fig.cap='Contoh lembar data petak vegetasi'}
knitr::include_graphics("images/ldv_ip.jpg")
```
...
**Kode foto:** Nomor foto di kamera 
**Keterangan:** Catatan atau keterangan tambahan jika diperlukan

```{r ldvm, echo=FALSE, out.width = '100%',fig.align='center',fig.cap='Contoh lembar data vegetasi'}
knitr::include_graphics("images/ldv_m.jpg")
```

<!--chapter:end:08-lampiran1.Rmd-->
