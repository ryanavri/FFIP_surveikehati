...
```{r ranting, echo=FALSE, out.width = '100%',fig.align='center',fig.cap='Bagian tumbuhan seteleah digunting 30 cm'}
knitr::include_graphics("images/ranting.jpg")
```
...
```{r preherba, echo=FALSE, out.width = '100%',fig.align='center',fig.cap='Membungkus ranting dengan kertas koran dan pengepresan dengan triplek'}
knitr::include_graphics("images/preherba.png")
```
...
```{r oven, echo=FALSE, out.width = '100%',fig.align='center',fig.cap='Pengeringan dengan menggunakan oven'}
knitr::include_graphics("images/oven.jpeg")
```
...
```{r herba, echo=FALSE, out.width = '100%',fig.align='center',fig.cap='Herbarium yang sudah kering dan siap disimpan '}
knitr::include_graphics("images/herba.jpg")
```
